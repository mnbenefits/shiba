...
public class FullFlowJourneyTest extends JourneyTest {
	...
	void fullApplicationWithDocumentUploads() {
		...
		testPage.clickContinue("Past benefits");
		testPage.chooseYesOrNo("hasPastBenefits", NO.getDisplayValue(), "Previous EBT Card");
	...
	void fullCashApplication() {
		...
		testPage.enter("healthcareCoverage", YES.getDisplayValue());
		testPage.clickContinue("Past benefits");
		testPage.chooseYesOrNo("hasPastBenefits", NO.getDisplayValue(), "Getting benefits sent to your bank account");
