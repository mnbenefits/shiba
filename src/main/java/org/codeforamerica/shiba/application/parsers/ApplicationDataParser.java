...
public class ApplicationDataParser {
  ...
  static {
    ...
    coordinatesMap.put(Field.IDENTIFY_COUNTY_LATER_DOCS, new ParsingCoordinate("identifyCountyOrTribalNation", "county"));//TODO emj delete this
  ...
  public enum Field {
    ...
    IDENTIFY_COUNTY_LATER_DOCS("Other"), //TODO emj delete this?
