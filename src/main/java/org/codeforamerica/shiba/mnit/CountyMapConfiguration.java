...
public class CountyMapConfiguration {
  ...
  ServicingAgencyMap<CountyRoutingDestination> productionMapping() {
    initializeDefaultCountyMap();
    updateCounty(Aitkin, "financial.services@co.aitkin.mn.us", "A000001900");
    ...
    updateCounty(Chisago, "hhsim@chisagocountymn.gov", "1659408904");
    ...
    updateCounty(CrowWing, "cwcss@crowwing.gov", "A000018300");
    ...
    updateCounty(Hubbard, "humanservices@co.hubbard.mn.us", "A000029900");
    ...
    updateCounty(Meeker, "hhs.info@co.meeker.mn.us", "A000047700");
    ...
    updateCounty(RedLake, "reception@mail.co.red-lake.mn.us", "A000063900");
    updateCounty(Redwood, "ssintake@swmhhs.com", "A000064700");
    updateCounty(Renville, "hs@renvillecountymn.gov", "M000065500");
    ...
    updateCounty(Sibley, "ContactPHHS@co.sibley.gov", "A000072800");
    ...
    updateCounty(Traverse, "Shelly.staebler@co.traverse.mn.us", "A000078700");
    ...
    updateCounty(Washington, "stephanie.schlageter@washingtoncountymn.gov", "1700969334");
  ...
  private void initializeDefaultCountyMap() {
    ...
    addCountyDefaults(Stearns, "A000073600", "320-650-5839");
